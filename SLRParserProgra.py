class SLRParser:
    def __init__(self):
        ...
        self.accepted = False #don't need this
    ...
    def parse(self, input):
        ...
        while not self.accepted:
            ...
            if action is None:
                print("Error: Invalid input at position")
                print("String is not accepted")
                return
            te = [str(i) for i in self.stack]
            print(f"{''.join(te):>20} {self.input_string[self.current_index:]:>10} {action:>10}")
            ...
            if action.startswith("S"):
                ...
                n=len(self.grammar[production_num-1][1])*2
...
parser2 = SLRParser()
input_string2 = "(i*(i*i))"
parser2.parse(input_string2)
parser3 = SLRParser()
input_string3 = "i+"
parser3.parse(input_string3)
